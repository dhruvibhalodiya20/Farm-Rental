...
namespace famrhouserent.Migrations
{
    ...
    [Migration("20250424092743_bookedadultremove")]
    partial class bookedadultremove
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("famrhouserent.Models.Feedback", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("famrhouserent.Models.Contact", b =>
                {
                    b.HasOne("famrhouserent.Models.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("famrhouserent.Models.Feedback", b =>
                {
                    b.HasOne("famrhouserent.Models.Booking", "Booking")
                        .WithMany()
